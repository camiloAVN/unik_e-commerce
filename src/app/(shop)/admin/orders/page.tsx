      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-4 sm:py-8">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button className="px-3 py-1.5 bg-lime-400 text-white text-sm border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50" disabled>
              Previous
            </button>
            <button className="px-3 py-1.5 text-sm bg-lime-100 text-lime-700 border border-lime-200 rounded-lg font-medium">
              1
            </button>
            <button className="px-3 py-1.5 bg-lime-400 text-black text-sm border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              2
            </button>
            <button className="px-3 py-1.5 bg-lime-400 text-black text-sm border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              Next
